...
if __name__ == '__main__':
    dataset = np.loadtxt("./ch8/adult_dataset/adult_train_feature.txt")
    label = np.loadtxt("./ch8/adult_dataset/adult_train_label.txt")
    test_set = np.loadtxt("./ch8/adult_dataset/adult_test_feature.txt")
    test_label = np.loadtxt("./ch8/adult_dataset/adult_test_label.txt")
